...
interesting failures live BETWEEN them. "awrun is installed" is not the useful
fact -- "awrun is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awrun needs at runtime, and a
